...
namespace Honda_Net_Typer
{
	...
	public partial class Honda_Net_Typer_BPODataContext : System.Data.Linq.DataContext
	{
    ...
    partial void Deletetbl_Version(tbl_Version instance);
		...
		public Honda_Net_Typer_BPODataContext() : 
				base(global::Honda_Net_Typer.Properties.Settings.Default.DatabaseDataEntryBPOConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public Honda_Net_Typer_BPODataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public Honda_Net_Typer_BPODataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public Honda_Net_Typer_BPODataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public Honda_Net_Typer_BPODataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<tbl_User_copy2> tbl_User_copy2s
		{
			get
			{
				return this.GetTable<tbl_User_copy2>();
			}
		}
        ...
        internal void UpdateTimeFree(object token, int freeTime)
        {
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tbl_User_copy2")]
	public partial class tbl_User_copy2
	{
